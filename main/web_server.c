...
static const char INDEX_HTML[] =
    ...
    ".meas-freq-row{display:flex;gap:6px;align-items:center;margin-top:4px}"
    ".meas-freq-row input{flex:1;min-width:0}"
    ".xtal-cal-row{display:flex;gap:6px;align-items:center;margin-top:2px}"
    ".xtal-cal-row input{flex:1;min-width:0}"
    ...
    "<input id='xtal_cal' type='number' min='-200000' max='200000' step='100'>"
